...
Project-scoped skills for zStellar (private payments dApp on Stellar). Pair these with the official Stellar skills (`stellar-skills-hub`).
...
| `stellar-zk-primitives` | zStellar application of BN254 / Poseidon / Groth16 verification. |
