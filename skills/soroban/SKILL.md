...
> zStellar reuses the Nethermind PoC contracts; only relevant if we fork the Pool/Verifier/ASP contracts (plan D1). See `../stellar-private-payments-poc/SKILL.md`.
