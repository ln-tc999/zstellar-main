...
description: Wire the zStellar Next.js frontend to Stellar — wallet connect (Stellar Wallets Kit / Freighter), stellar-sdk, Soroban RPC, testnet account funding, transaction signing/submission, and cross-origin-isolation headers for WASM proof gen. Use when building the connect/dashboard/submit layers.
---

# Stellar frontend integration (zStellar)
