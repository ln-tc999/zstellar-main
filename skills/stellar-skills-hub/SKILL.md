...
| Module | Focus | Relevance to zStellar |
|--------|-------|---------------------|
...
- **stellar-build** — https://github.com/kaankacar/stellar-build
  42-skill installer covering the full journey idea → mainnet deploy → SCF grant submission, with six DevRel-persona agents. 🟡 broader than zStellar MVP; useful for deploy/grant later.
...
OpenZeppelin Contracts · DeFindex SDK · Soroswap SDK · Trustless Work Escrow. Use with caution; not needed for zStellar MVP.
