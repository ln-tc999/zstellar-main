...
export class WebClient {
     ...
     * @returns {Promise<any>}
     */
    executeTransfer(pool_contract_id, user_address, amount, recipient_note_key_hex, recipient_enc_key_hex, submit_fn, on_status, sender_address) {
        const ptr0 = passStringToWasm0(pool_contract_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(user_address, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        ...
        const ptr4 = passStringToWasm0(sender_address, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len4 = WASM_VECTOR_LEN;
        const ret = wasm.webclient_executeTransfer(this.__wbg_ptr, ptr0, len0, ptr1, len1, addHeapObject(amount), ptr2, len2, ptr3, len3, addHeapObject(submit_fn), isLikeNone(on_status) ? 0 : addHeapObject(on_status), ptr4, len4);
        return takeObject(ret);
    }
    /**
     * @param {string} pool_contract_id
     ...
     * @returns {Promise<any>}
     */
    executeWithdraw(pool_contract_id, user_address, withdraw_recipient, amount, submit_fn, on_status, sender_address) {
        const ptr0 = passStringToWasm0(pool_contract_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(user_address, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        ...
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(sender_address, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.webclient_executeWithdraw(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, addHeapObject(amount), addHeapObject(submit_fn), isLikeNone(on_status) ? 0 : addHeapObject(on_status), ptr3, len3);
        return takeObject(ret);
    }
    /**
     * @param {string} pool_contract_id
...
function __wasm_bindgen_func_elem_6955(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_6955(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
